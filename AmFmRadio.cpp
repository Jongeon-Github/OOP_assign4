...
void AmFmRadio::PowerToggle() {
    if (on == true) {
        ...
        /* feedback fix */
            ...
            currentFreq.AMFreq = 530; // Set default AM frequency if previous frequency was 530
        }
        ...
        /* feedback fix */
            ...
            currentFreq.FMFreq = 87.9; // Set default FM frequency if previous frequency was 87.9
        }
    }
}
